...
arrange(hflights_df, Year, Month, DepTime, ArrTime) #정렬 기능 함수
...
# 컬럼의 범위 지정하기.
select(hflights_df, Year:ArrTime)#year부터 arrtime까지 범위 지정. 
...
# 비행시간 평균 계산하기. 유사한 summary함수가 있다. 6개의 데이터 특징(min max mean 1234분위값)을 계산해 주는 함수. 
