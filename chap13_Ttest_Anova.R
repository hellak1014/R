...
# 단계4. 교육 방법별로 분리
a <- subset(result, method == 1) #PT
b <- subset(result, method == 2) #coding
a;b
...
# (2) 동질성 검정
var.test(a1, b1) # p-value = 0.3002 > α(유의수준) : t-검정 0.3002 > 0.05 => t-검정
